...
def base_context():
    return {
        "author_name": "Jeanne Deau",
        "email": "jeanne.deau@example.fr",
        "github_username": "jdeau",
        "name": "Snake Farm",
        "description": "A sample farming project",
    }
...
def test_generate_project(cookies, base_context, branding_color):
    result = cookies.bake(
        extra_context={**base_context, "branding_color": branding_color}
    )
